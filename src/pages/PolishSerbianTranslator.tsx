...
const PolishSerbianTranslator = () => {
  ...
  const handleTranslate = async () => {
    ...
    setTimeout(() => {
      setTranslatedText("Ovo je primer prevoda sa poljskog na srpski koji će biti zamenjen stvarnim prevodom.");
      setIsTranslating(false);
    }, 1000);
  };

  const handleSwapLanguages = () => {
    // Redirect to Serbian-Polish translator
    window.location.href = "/prevodilac-srpski-poljski";
  };
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-4">
            Prevedi tekst sa poljskog na srpski online
          </h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Brz i tačan prevod sa poljskog jezika na srpski. Besplatno, uz opciju izgovora teksta.
          </p>
        </div>
        ...
        <div className="translator-surface p-6 mb-8">
          ...
          <div className="flex items-center justify-center gap-4 mb-6">
            <div className="flex items-center gap-2 h-12 px-4 rounded-lg border border-card-border bg-card">
              ...
              <span className="font-medium text-card-foreground">Poljski</span>
            </div>
            <Button
              variant="ghost"
              size="sm"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <textarea
                ...
                placeholder="Wprowadź tekst do tłumaczenia..."
        ...
        <div className="max-w-4xl mx-auto mb-8">
          <h2 className="text-2xl font-bold text-foreground mb-4">
            Zašto koristiti naš prevodilac sa poljskog na srpski?
          </h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-semibold mb-2">Brz i precizan prevod</h3>
              <p className="text-muted-foreground">
                Naš napredni algoritam obezbeđuje brze i tačne prevode sa poljskog na srpski jezik,
            ...
            <div>
              <h3 className="text-lg font-semibold mb-2">Složena poljska fonologija</h3>
              <p className="text-muted-foreground">
                Poljski ima jedinstvene glasove i pisanje koje zahteva preciznu transliteraciju. Naš sistem je obučen na velikim korpusima poljskog
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Link to="/prevodilac-srpski-poljski" className="block">
...
export default PolishSerbianTranslator;