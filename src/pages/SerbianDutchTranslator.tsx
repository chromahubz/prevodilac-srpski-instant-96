...
const SerbianDutchTranslator = () => {
  ...
  const handleTranslate = async () => {
    ...
    setTimeout(() => {
      setTranslatedText("Dit is een voorbeeld van een vertaling van het Servische naar het Nederlandse.");
      setIsTranslating(false);
    }, 1000);
  };

  const handleSwapLanguages = () => {
    // Redirect to Dutch-Serbian translator
    window.location.href = "/prevodilac-holandski-srpski";
  };
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-4">
            Prevedi tekst sa srpskog na holandski online
          </h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Brz i tačan prevod sa srpskog jezika na holandski. Besplatno, uz opciju izgovora teksta.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto prose prose-gray">
          <h2 className="text-2xl font-bold text-foreground mb-4">
            Zašto koristiti naš prevodilac sa srpskog na holandski?
          </h2>
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div>
              <h3 className="text-lg font-semibold mb-2">Brz i precizan prevod</h3>
              <p className="text-muted-foreground">
                Naš napredni algoritam obezbeđuje brze i tačne prevode sa srpskog na holandski jezik,
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                što pomaže u učenju pravilne holandske izgovaranja.
              </p>
            </div>
            <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <Link to="/prevodilac-srpski-nemacki" className="block">
            <Button variant="outline" className="w-full h-12 text-sm font-medium">
              Srpski → Nemački
            </Button>
          </Link>
...
export default SerbianDutchTranslator;