...
const SerbianTurkishTranslator = () => {
  ...
  const handleTranslate = async () => {
    ...
    setTimeout(() => {
      setTranslatedText("Bu Sırpçadan Türkçeye çeviri örneğidir.");
      setIsTranslating(false);
    }, 1000);
  };

  const handleSwapLanguages = () => {
    // Redirect to Turkish-Serbian translator
    window.location.href = "/prevodilac-turski-srpski";
  };
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-4">
            Prevedi tekst sa srpskog na turski online
          </h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Brz i tačan prevod sa srpskog jezika na turski. Besplatno, uz opciju izgovora teksta.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto prose prose-gray">
          <h2 className="text-2xl font-bold text-foreground mb-4">
            Zašto koristiti naš prevodilac sa srpskog na turski?
          </h2>
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div>
              <h3 className="text-lg font-semibold mb-2">Brz i precizan prevod</h3>
              <p className="text-muted-foreground">
                Naš napredni algoritam obezbeđuje brze i tačne prevode sa srpskog na turski jezik,
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                što pomaže u učenju pravilne turske izgovaranja.
              </p>
            </div>
            <div>
...
export default SerbianTurkishTranslator;