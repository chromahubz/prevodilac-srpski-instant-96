...
const NorwegianSerbianTranslator = () => {
  ...
  const handleTranslate = async () => {
    ...
    setTimeout(() => {
      setTranslatedText("Ovo je primer prevoda sa norveškog na srpski koji će biti zamenjen stvarnim prevodom.");
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-4">
            Prevedi tekst sa norveškog na srpski online
          </h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Brz i tačan prevod sa norveškog jezika na srpski. Besplatno, uz opciju izgovora teksta.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-8">
          <h2 className="text-2xl font-bold text-foreground mb-4">Norveški prevodilac - Norsk oversetter</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-semibold mb-2">Tačan prevod norveškog</h3>
              <p className="text-muted-foreground">
                Norveški jezik sa svojom skandinavskom lepotom zahteva precizan prevod 
                koji čuva originalnu jednostavnost i jasnoću.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-2">Za skandinavske jezike</h3>
              <p className="text-muted-foreground">
                Savršen alat za komunikaciju sa Norvežanima ili 
                za potrebe studija i poslovnih kontakata u Norveškoj.
              </p>
            </div>
          </div>
        </div>
