      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        <div className="max-w-4xl mx-auto mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-2">Aglutinativni turski jezik</h3>
              <p className="text-muted-foreground">
                Turska gramatika gradi reči dodavanjem sufiksa, što zahteva posebnu pažnju. Naš sistem je obučen na velikim korpusima turskog
