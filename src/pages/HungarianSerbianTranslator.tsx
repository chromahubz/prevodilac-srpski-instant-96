      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        <div className="max-w-4xl mx-auto mb-8">
          <h2 className="text-2xl font-bold text-foreground mb-4">
            Zašto koristiti naš prevodilac sa mađarskog na srpski?
          </h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-semibold mb-2">Brz i precizan prevod</h3>
              <p className="text-muted-foreground">
                Naš napredni algoritam obezbeđuje brze i tačne prevode sa mađarskog na srpski jezik,
            ...
            <div>
              <h3 className="text-lg font-semibold mb-2">Jedinstvena mađarska struktura</h3>
              <p className="text-muted-foreground">
                Mađarski kao ugrofiski jezik zahteva poseban pristup aglutinativnoj gramatici. Naš sistem je obučen na velikim korpusima mađarskog
