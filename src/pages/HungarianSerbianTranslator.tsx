...
const HungarianSerbianTranslator = () => {
  ...
  const handleTranslate = async () => {
    ...
    setTimeout(() => {
      setTranslatedText("Ovo je primer prevoda sa mađarskog na srpski koji će biti zamenjen stvarnim prevodom.");
      setIsTranslating(false);
    }, 1000);
  };

  const handleSwapLanguages = () => {
    window.location.href = "/prevodilac-srpski-madjarski";
  };
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-4">
            Prevedi tekst sa mađarskog na srpski online
          </h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Brz i tačan prevod sa mađarskog jezika na srpski. Besplatno, uz opciju izgovora teksta.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="space-y-4">
              <textarea
                ...
                placeholder="Írjon be szöveget a fordításhoz..."
                className="translator-input"
                maxLength={500}
              />
              <div className="flex justify-between items-center text-sm text-muted-foreground">
                <span>{sourceText.length}/500 karakter</span>
        ...
        <div className="max-w-4xl mx-auto mb-8">
          <h2 className="text-2xl font-bold text-foreground mb-4">Mađarski prevodilac - Magyar fordító</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-semibold mb-2">Tačan prevod mađarskog</h3>
              <p className="text-muted-foreground">
                Mađarski jezik sa svojom jedinstvenom strukturom zahteva precizan prevod 
                koji poštuje specifičnosti ugro-finske porodice jezika.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-2">Za susedske zemlje</h3>
              <p className="text-muted-foreground">
                Savršen alat za komunikaciju sa Mađarskim susedima ili 
                za potrebe turizma i poslovnih kontakata.
              </p>
            </div>
          </div>
        </div>
...
export default HungarianSerbianTranslator;