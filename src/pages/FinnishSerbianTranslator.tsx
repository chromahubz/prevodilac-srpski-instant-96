...
const FinnishSerbianTranslator = () => {
  ...
  const handleTranslate = async () => {
    ...
    setTimeout(() => {
      setTranslatedText("Ovo je primer prevoda sa finskog na srpski koji će biti zamenjen stvarnim prevodom.");
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Brz i tačan prevod sa finskog jezika na srpski. Besplatno, uz opciju izgovora teksta.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="space-y-4">
              <textarea
                ...
                placeholder="Syötä tekstiä käännettäväksi..."
                className="translator-input"
                maxLength={500}
              />
              <div className="flex justify-between items-center text-sm text-muted-foreground">
                <span>{sourceText.length}/500 merkkiä</span>
        ...
        <div className="max-w-4xl mx-auto mb-8">
          <h2 className="text-2xl font-bold text-foreground mb-4">Finski prevodilac - Suomalainen kääntäjä</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-semibold mb-2">Tačan prevod finskog</h3>
              <p className="text-muted-foreground">
                Finski jezik sa svojom jedinstvenom ugro-finskom strukturom zahteva poseban pristup u prevodu 
                koji poštuje kompleksnost padežnog sistema.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-2">Za severnoevropske jezike</h3>
              <p className="text-muted-foreground">
                Savršen alat za komunikaciju sa Fincima ili 
