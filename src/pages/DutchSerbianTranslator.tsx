...
const DutchSerbianTranslator = () => {
  ...
  const handleSwapLanguages = () => {
    // Redirect to Serbian-Dutch translator
    window.location.href = "/prevodilac-srpski-holandski";
  };
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-4">
            Prevedi tekst sa holandskog na srpski online
          </h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Brz i tačan prevod sa holandskog jezika na srpski. Besplatno, uz opciju izgovora teksta.
          </p>
        </div>
        ...
        <div className="translator-surface p-6 mb-8">
          ...
          <div className="flex items-center justify-center gap-4 mb-6">
            <div className="flex items-center gap-2 h-12 px-4 rounded-lg border border-card-border bg-card">
              ...
              <span className="font-medium text-card-foreground">Holandski</span>
            </div>
            <Button
              variant="ghost"
              size="sm"
        ...
        <div className="max-w-4xl mx-auto mb-8">
          <h2 className="text-2xl font-bold text-foreground mb-4">
            Zašto koristiti naš prevodilac sa holandskog na srpski?
          </h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-semibold mb-2">Brz i precizan prevod</h3>
              <p className="text-muted-foreground">
                Naš napredni algoritam obezbeđuje brze i tačne prevode sa holandskog na srpski jezik,
            ...
            <div>
              <h3 className="text-lg font-semibold mb-2">Germanski holandski jezik</h3>
              <p className="text-muted-foreground">
                Holandski deli karakteristike sa nemačkim ali ima svoje specifične izraze. Naš sistem je obučen na velikim korpusima holandskog
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Link to="/prevodilac-srpski-holandski" className="block">
...
export default DutchSerbianTranslator;