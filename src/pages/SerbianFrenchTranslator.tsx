...
const SerbianFrenchTranslator = () => {
  ...
  const handleTranslate = async () => {
    ...
    try {
      const result = await translateText(sourceText, "sr", "fr");
  ...
  const handleSwapLanguages = () => {
    window.location.href = "/prevodilac-francuski-srpski";
  };
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
            ...
            <div className="space-y-4">
              ...
              {translatedText && (
                <div className="flex justify-between items-center">
                  <TTSButton text={translatedText} lang="fr" isRegistered={isRegistered} isPremium={isPremium} />
                </div>
              )}
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto mb-8">
          <h2 className="text-2xl font-bold text-foreground mb-4">
            Srpski prema francuskom
          </h2>
          <p className="text-muted-foreground mb-6">
            Efikasno prevođenje srpskog na francuski jezik uz poštovanje elegantne francuske gramatike i kulturoloških specifičnosti.
          </p>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-semibold mb-2">Profesionalan prevod srpsko-francuski</h3>
              <p className="text-muted-foreground">
                Naš napredni algoritam obezbeđuje precizne prevode sa srpskog na francuski jezik,
                čuvajući kontekst i značenje originalnog teksta. Sistem prepoznaje elegantnu
                francusku gramatiku i optimizovan je za prirodnu komunikaciju.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-2">Elegantna francuska gramatika</h3>
              <p className="text-muted-foreground">
                Prepoznaje specifičnosti francuske gramatike uključujući rodove, slaganje prideva
                i složene glagolske forme. Naš sistem je obučen na velikim korpusima francuskog
                teksta što omogućava prirodno oblikovanje francuski rečenica.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-2">Prirodan audio izgovor</h3>
              <p className="text-muted-foreground">
                Slušajte prevod izgovoren prirodnim francuskim glasom visokeg kvaliteta. Korisno je za učenje
                francuskog jezika, proveru izgovora ili pomoć osobama sa poteškoćama u čitanju. Audio se generiše
